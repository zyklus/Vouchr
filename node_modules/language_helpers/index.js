...
var isNumber   = exports.isNumber   = function isNumber  (obj){ return toString.call(obj) === "[object Number]";   };
...
Function.prototype.foo = 42;

Object.defineProperties(Object.prototype, {
	defineProperty : {
		value : function( prop, val ){
			Object.defineProperty(this, prop, (val.value || val.get || val.set) ? val : { value : val });
		}
	},
	defineProperties : {
...
Function.prototype.defineProperties({
	bindArgs : function() {
...
Array.prototype.defineProperties({
...
String.prototype.defineProperties({
